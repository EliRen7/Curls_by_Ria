...
<div className="hero-content  flex-col lg:flex-row-reverse ">
  ...
  <Image 
    ...
    <p className="text-5xl ml-32 md:ml-0 p-10 md:py-4 md:p-28 md:text-2xl text-black font-about" data-aos="fade-left"> 
    ✨South Korea&apos;s first official curl specialist!✨ 
     </p> 
     <p className="text-5xl text-korean-description p-10 md:py-0 ml-56 md:ml-0 md:p-40 md:text-2xl font-koreanHeader" data-aos="fade-left">
