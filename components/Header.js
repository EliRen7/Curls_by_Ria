...
<div className="hero-content  flex-col lg:flex-row-reverse ">
  ...
  <Image 
    ...
    ✨South Korea&apos;s first official curl specialist!✨ 
     ...
     <div className='z-50 fixed ml-[60rem] h-28 w-28 rounded-full mt-10 md:mt-10 md:w-10 md:h-10 md:ml-[81rem] bg-gradient-to-r from-rose-100 to-rose-300 md:rounded-3xl opacity-60 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" data-aos="fade-left "' data-aos="fade-up">
      <a href='#home'>
