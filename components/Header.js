...
function Header(){
    return( 
   <div
  class="hero min-h-screen bg-korean-description w-[84rem] h-[185rem] md:w-full pb-96 md:pb-0 md:hero min-h-screen md:h-screen">
  <div className="hero-overlay"></div>
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md">
      <h1 className="mb-5 text-5xl font-bold md:text-4xl">Hello there</h1>
      <p className="mb-5 text-lg md:ml-56 p-10 md:py-4 md:p-28 md:text-2xl">
