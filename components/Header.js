...
<div className="hero-content flex-col lg:flex-row-reverse">
  ...
  <img src='/assets/curlsbyrialogo2.png'  className=" mr-20 w-full md:w-9/12 md:mr-20 md:mt-10 md:ml-5" alt='img' data-aos="fade-down-right"/>
    ...
    excepturi exercitationem quasi. 
     ...
     <div className='z-50 fixed ml-[70rem] h-28 w-28 rounded-full md:w-10 md:h-10 md:ml-[81rem] bg-gradient-to-r from-purple-600 to-pink-600 md:rounded-3xl opacity-60 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" data-aos="fade-left "' data-aos="fade-up">
      <a href='#home'>
