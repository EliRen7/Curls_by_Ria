  ...
  return (
    ...
    <div>
      ...
      <label htmlFor="my-modal-4" className="modal cursor-pointer">
        <label htmlFor="" className="modal-box relative max-w-6xl max-h-max md:h-5/6 md:max-w-lg bg-tan ">
          <h3 className="text-7xl md:text-lg font-bold text-center">Welcome!</h3>
   ...
   <span className='ml-10 mt-5 text-5xl md:text-base'><b>Deposit prices (Korean Bank Transfer option)</b>
   <br></br><b className='ml-40 md:ml-20'>예약금표 (계좌이체 가능) </b>
   </span>
        <label className="label cursor-pointer ml-5 text-5xl md:text-base">
      ...
      <div className="form-control">
        <label className="label cursor-pointer ml-5 text-5xl md:text-base">
          <label>Curl Cultivation - ₩75,000 *existing clients</label> 
            ...
            <label className="input-group text-5xl md:text-sm m-4 pt-10 md:pt-0">
            ...
            <div className="divider">OR</div>
              <select 
                id="options" 
                className="select ml-80 md:ml-20 mb-10 w-full max-w-md"
                value={services}
