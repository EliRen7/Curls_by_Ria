...
export default function Location(){
  ...
  <a href="#english-location" className="btn md:text-md text-5xl btn-lg md:btn-xs bg-rose-300 border-none">English</a> 
  <a href="#korean-location" className="btn md:text-md text-5xl btn-lg md:btn-xs bg-rose-300 border-none">한국어</a> 
</div> 
<div className="carousel w-full">
 <div id="english-location" className="carousel-item w-full">
     <p className="indent-9 pl-20 md:p-20 text-7xl md:text-lg text-justify mt-60 md:mt-[0rem]" > 
     It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.
      The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable
       English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have 
     evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).
 </p>
 </div>
 
       <div id="korean-location" className="carousel-item w-full">
         <p className="indent-9 pl-20 md:p-20 text-7xl md:text-lg text-justify mt-60 md:mt-[0rem]" > 
         안녕하세요 여러분! 저는 리아라고 하고요, Curls by Ria의 대표입니다~ 저는 2018년부 때부터 미용에 대해 열정과 관심이 있었습니다. 그래서 제가 사랑하는 것과 잘하는 것과 다른 사람들이 필요하는 것을 하는 상황이 나타났을 때 운명처럼 보였습니다. 2021년부터 제가 최고의 곱슬머리 전문가가 되기 위해 많은 투자를 했습니다. 그동안  Curly Hair Artistry (반곱슬~곱슬머리 기술 교육) 마스터 프로그램과 Cut it Kinky(강한곱슬머리 기술 교육)를 통해 곱슬머리 전문적인 교육을 받았습니다. 그리고 고객들에게 더 많은 서비스를 제공할 수 있게 2023년 4월에 이용사 국가기술자격증을 취득했습니다.
