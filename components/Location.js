...
export default function Location(){
  ...
  <a href="#englishlocation" className="btn md:text-md text-5xl btn-lg md:btn-xs bg-rose-300 border-none">English</a> 
  <a href="#koreanlocation" className="btn md:text-md text-5xl btn-lg md:btn-xs bg-rose-300 border-none">한국어</a> 
</div> 
