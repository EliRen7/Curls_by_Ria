function About(){
    return (
     ...
     <h1 className="font-headers text-9xl md:text-5xl pt-[3rem] text-rose-300 ml-[29rem] md:ml-[38rem] mb-5"  data-aos="fade-right" >About Me</h1>
    <div className="card lg:card-side w-11/12 md:ml-[7rem]">
  <img src="./assets/IMG_1029.JPG" className="md:w-96 md:h-full md:mt-48 mt-10 mr-10 rotate-6 rounded-3xl hover:rotate-12"/>
 <div className="card-body md:gap-4" data-aos="fade-left">
 <div className="flex justify-center w-full py-2 gap-3 md:mx-0.5">
  <a href="#english" className="btn btn-xs bg-rose-300 border-none">English</a> 
  <a href="#korean" className="btn btn-xs bg-rose-300 border-none">한국어</a> 
</div> 
 <h2 className="card-title font-about ml-20 md:mx-[19rem] text-8xl md:text-3xl text-rose-300">Hey y’all!</h2>
 <div className="carousel w-full">
 <div id="english" className="carousel-item w-full">
     <p className="pl-20 md:pl-5 text-7xl md:text-lg text-justify mt-5 md:mt-[5rem]" > 
    ...
    <br></br>
     When you visit Curls by Ria, I hope you know that you are in safe hands, and I am always here to listen to what YOU want and need. Thanks for reading, and I can’t wait to meet you!
       ...
       <div id="korean" className="carousel-item w-full">
         <p className="pl-20 md:pl-5 text-7xl md:text-lg text-justify mt-5 md:mt-[5rem]" > 
         안녕하세요 여러분! 저는 리아라고 하고요, Curls by Ria의 대표입니다~ 저는 2018년부터 곱슬머리에 관해 관심을 생겼고 개인적으로 곱슬머리를 관리법에 대해 배우기 시작했습니다. 그러던 2021년에 미용사 (헤어) 국가기술자격증을 취득하고 Curls by Ria를 창립하게 되었습니다. 저는 사실 중학교 때부터 미용에 대해 열정과 관심이 있었습니다. 그래서 제가 사랑하는 것과 잘하는 것과 다른 사람들이 필요로 하는 것을 하는 상황이 나타났을 때 운명처럼 보였습니다. 2021년부터 제가 최고의 곱슬머리 전문가가 되기 위해 많은 투자를 했습니다. 그동안  Curly Hair Artistry (반곱슬~곱슬머리 기술 교육) 마스터 프로그램과 Cut it Kinky(강한곱슬머리 기술 교육)를 통해 곱슬머리 전문적인 교육을 받았습니다. 그리고 고객들에게 더 많은 서비스를 제공할 수 있게 2023년 4월에 이용 국가기술자격증을을 취득했습니다.
         <br></br>
         이제, 그 지루한 내용은 그만~! 저는 핑크색에 아주아주 사랑하는 포켓몬 띠부실를 모으는 미국 교포일 뿐이에요 ㅋㅋㅋ 아! 그리고 저는 항상 강아지 두 마리(감자와 슈돌)와 함께 일하는데 혹시 강아지 알레르기가 있거나 예민하신 분들은 알려주세요~
         <br></br>
  ...
  <div className="md:invisible divider p-20"></div>
</div>
</div>
    )
}
...
// </p>
//       <br></br>
//         <p className="pl-20 md:pl-0 text-7xl md:text-lg text-justify" > 
//         안녕하세요 여러분! 저는 리아라고 하고요, Curls by Ria의 대표입니다~ 저는 2018년부터 곱슬머리에 관해 관심을 생겼고 개인적으로 곱슬머리를 관리법에 대해 배우기 시작했습니다. 그러던 2021년에 미용사 (헤어) 국가기술자격증을 취득하고 Curls by Ria를 창립하게 되었습니다. 저는 사실 중학교 때부터 미용에 대해 열정과 관심이 있었습니다. 그래서 제가 사랑하는 것과 잘하는 것과 다른 사람들이 필요로 하는 것을 하는 상황이 나타났을 때 운명처럼 보였습니다. 2021년부터 제가 최고의 곱슬머리 전문가가 되기 위해 많은 투자를 했습니다. 그동안  Curly Hair Artistry (반곱슬~곱슬머리 기술 교육) 마스터 프로그램과 Cut it Kinky(강한곱슬머리 기술 교육)를 통해 곱슬머리 전문적인 교육을 받았습니다. 그리고 고객들에게 더 많은 서비스를 제공할 수 있게 2023년 4월에 이용 국가기술자격증을을 취득했습니다.
//         <br></br>
//         이제, 그 지루한 내용은 그만~! 저는 핑크색에 아주아주 사랑하는 포켓몬 띠부실를 모으는 미국 교포일 뿐이에요 ㅋㅋㅋ 아! 그리고 저는 항상 강아지 두 마리(감자와 슈돌)와 함께 일하는데 혹시 강아지 알레르기가 있거나 예민하신 분들은 알려주세요~
//         <br></br>
