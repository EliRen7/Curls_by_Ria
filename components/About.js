...
function About(){
    return (
     ...
     <h1 className="font-header text-9xl md:text-5xl pt-5 text-korean-description ml-[20rem] md:ml-[38rem] mb-5"  data-aos="fade-right" >About Me</h1>
 ...
 <h2 className="card-title font-header ml-[25rem] md:ml-[22rem] md:mx-[21rem] text-8xl md:text-3xl text-korean-description">Hey y’all!</h2>
