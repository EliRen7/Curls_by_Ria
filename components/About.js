...
import aboutMePic from '../public/assets/profile-pic.jpg'


function About(){
    return (
        <div className="bg-white w-[84rem] md:w-full" id="about">
     <h1 className="font-header text-9xl md:text-5xl pt-20 text-korean-description ml-[20rem] md:ml-[40rem] mb-5"  data-aos="fade-right" >About Me</h1>
 ...
 <h2 className="card-title font-header ml-[25rem] md:ml-[25rem] md:mx-[21rem] text-8xl md:text-3xl text-korean-description">Hey y’all!</h2>
 <div className="carousel w-full">
 <div id="english" className="carousel-item w-full">
     <p className="indent-9 pl-20 md:pl-5 text-7xl md:text-lg text-justify mt-60 md:mt-[5rem] font-header" > 
    ...
    <br></br>
     When you visit Curls by Ria, I hope you know that you are in safe hands, and I am always here to listen to what YOU want and need. Thanks for reading, and I can’t wait to meet you!
       ...
       <div id="korean" className="carousel-item w-full">
         <p className="indent-9 pl-20 md:pl-5 text-7xl md:text-xl text-justify mt-60 md:mt-[5rem] font-KoreanHeader" > 
