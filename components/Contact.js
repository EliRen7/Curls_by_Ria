...
function Contact () {
    return(
        <section class="bg-tan dark:bg-gray-900 pt-40 pb-40 " id="contact">
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md rounded-3xl shadow-xl bg-zinc-100 ">
      <h2 class="mb-4 text-6xl tracking-tight font-extrabold text-center text-rose-300 font-headers">Contact Me!</h2>
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about a service? Need more details about a treatment option? Let me know.</p>
      <form action="https://formcarry.com/s/669I-RXBYjl" method="POST" accept-charset="UTF-8" class="space-y-8">
          <div>
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-rose-300 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
      </form> 
  </div>
