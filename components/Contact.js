...
function Contact () {
    return(
     <section className="bg-white w-[84rem] md:w-full pt-40 pb-60" id="contact">
  <div className="py-8 lg:py-16 px-4 mx-auto min-h-screen-xl max-w-screen-lg md:max-w-screen-md rounded-3xl shadow-xl bg-zinc-100 ">
      <h2 className="mb-4 text-8xl md:text-5xl tracking-tight text-center text-korean-description font-header">Contact Me!</h2>
      ...
      <form action="https://formcarry.com/s/NHVjBk1PS3S" method="POST" accept-charset="UTF-8" className="space-y-8">
          <div>
              <label for="email" className="block mb-2 text-4xl md:text-sm font-medium text-gray-300 dark:text-gray-400 ">Your email</label>
              <input name="email" type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-4xl md:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:bg-white dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@curlsbyria.com" required />
          </div>
          <div>
              <label for="subject" className="block mb-2 text-4xl md:text-sm font-medium text-gray-300 dark:text-gray-400 ">Subject</label>
              <input name="subject"type="text" id="subject" className="block p-3 w-full text-4xl md:text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:bg-white dark:placeholder-gray-400 dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Let me know how I can help you" required />
          </div>
          <div className="sm:col-span-2">
              <label for="message" className="block mb-2 text-4xl md:text-sm font-medium text-gray-300 dark:text-gray-400">Your message</label>
          ...
          <button type="submit" className=" py-8 md:py-3 px-5 text-5xl md:text-sm font-medium text-center text-white rounded-lg bg-korean-description sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Submit</button>
      </form> 
  </div>
