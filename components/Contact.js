...
function Contact () {
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto min-h-screen-xl max-w-screen-lg md:max-w-screen-md rounded-3xl shadow-xl bg-zinc-100 ">
      ...
      <form action="https://formcarry.com/s/5pQxq6cPy5" method="POST" accept-charset="UTF-8" className="space-y-8">
          <div>
              <label for="email" className="block mb-2 text-5xl md:text-sm font-medium text-gray-900 dark:text-gray-400 ">Your email</label>
          ...
          <div>
              <label for="subject" className="block mb-2 text-5xl md:text-sm font-medium text-gray-900 dark:text-gray-400 ">Subject</label>
